...
import { pixelBlastContainer } from "./PixelBlast.css";
import { colourPalette } from "#theme/colourPalette.js";
...
export const PixelBlast: React.FC<PixelBlastProps> = ({
  variant = "square",
  pixelSize = 3,
  color = colourPalette.cyanotype30,
  className,
  style,
  antialias = true,
  patternScale = 2,
  ...
  return (
    <div
      ref={containerRef}
      className={`${pixelBlastContainer} ${className ?? ""}`}
      style={style}
    />
  );
};
